...
@WebServlet(name = "GetDetailUserController", urlPatterns = {"/GetDetailUserController"})
public class GetDetailUserController extends HttpServlet {
   ...
   private static final String ERROR = "SearchUserController";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            UserDTO user = dao.getUserDetail(email);
            if (user != null) {
